...
export const FORMATE_DATE_TIME = "DD MMM YYYY, HH:mm";
export const FORMAT_DATE_DAYJS = "DD MMMM YYYY, HH:mm";
...
export const GMAIL = "@gmail.com";
export const TOTAL_DAY = 31;
...
export const SPP_PAYMENT_METHOD = [
    {
        value: 1,
        label: "Transfer",
    },
...
export const CLASS_OPTION = CLASSES.map((el) => ({ label: el, value: el }));
...
export const STAFF_PATH = {
    ...
    masterdata: {
        ...
        datapelajaran: {
            index: "/datapelajaran",
            add: "/datapelajaran/add",
            edit: "/datapelajaran/edit",
        },
    },
    infosiswa: {
        nilaisiswa: {
            index: "/nilaisiswa",
            edit: "/nilaisiswa/edit",
        },
        absensisiswa: {
            index: "/absensisiswa",
            edit: "/absensisiswa/edit",
        },
        sppsiswa: {
            index: "/sppsiswa",
            edit: "/sppsiswa/edit",
